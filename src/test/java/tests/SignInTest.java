...
public class SignInTest extends BaseTest{
    ...
    public void testLogin(){
        Assert.assertEquals(signInPage.Login(PropertiesFileReader.getPropValue("user"), PropertiesFileReader.getPropValue("pass")), "https://pos.anhtester.com/gui_pos");
    }
    ...
    public void testLoginWithDifferentAccount(String user, String pass){
        Assert.assertEquals(signInPage.Login(user, pass), "https://pos.anhtester.com/gui_pos/");
    }
}
